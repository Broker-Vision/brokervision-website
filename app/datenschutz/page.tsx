...
export default function PrivacyPage() {
  return (
    <>
      ...
      />
      <section className="mx-auto max-w-3xl space-y-10 px-5 py-16 text-navy-800/85 sm:px-8">
        <p className="text-sm text-navy-800/60">Stand: September 2026</p>

        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">1. Verantwortliche Stelle</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">2. Geltungsbereich</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">3. Hosting (Azure Static Web Apps)</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">4. Domain & Azure DNS</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">5. Azure Storage</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">6. Serverlogs</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">7. Kontaktformular</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">8. E-Mail-Kommunikation</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">9. Cookies & Tracking</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">10. Weitergabe an Auftragsbearbeiter</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">11. Speicherdauer</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">12. Ihre Rechte (DSG)</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">13. Datensicherheit</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">14. Änderungen</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-display text-2xl text-navy-900">15. Kontakt Datenschutz</h2>
          <p>
